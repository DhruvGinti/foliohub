...
import { motion } from "framer-motion"; // Note: Changed from motion/react for better tree-shaking and common usage
import { ArrowUpRight, ArrowDown } from "lucide-react";
import { Spotlight } from "./ui/Spotlight";
// import { Button } from "./ui/moving-border";

// These arrays are currently unused in the component.
...
const HeroSection = () => {
  ...
  return (
    // Use min-h-screen to ensure it always takes at least the full viewport height.
    // Added padding-x for mobile and adjusted padding-y.
    <div className="relative flex min-h-screen w-full flex-col overflow-hidden rounded-md bg-black py-10 px-4 text-white md:h-[40rem] md:flex-row md:py-0 md:px-0">
      ...
      <div className="relative z-10 flex w-full flex-col items-center justify-center text-center md:w-[65%] md:items-start md:pl-10 md:text-left">
        <motion.h1
          className="mt-20 text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 md:mt-0 md:text-7xl"
      ...
      {/* Right Side - This was empty, so we hide it on mobile to prevent unnecessary empty space */}
